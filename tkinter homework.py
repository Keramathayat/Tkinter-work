...
# def factorial1():
#     create = Toplevel()
#     create.title("Factorial")
#     create.geometry("800x800")
#     Label(create, text="Factorial", fg="black", font="family, 20").pack()
#     text1 = Text(create)
#     text1.pack()
#
#     def save():
...
#     b1 = Button(create, text="save", command=save)
#     b1.pack()
#
#     def show():
...
#     b2 = Button(create, text="show", command=show)
#     b2.pack()
l = Label(root, text="{ My Homework }", fg="purple", font="Algerian, 25")
l.pack()

Label(root, text="~", font="20").pack()
l1 = Label(root, text="1-First (Factorial)", fg="red", font="Algerian")
l1.pack()
b1 = Button(root, text="Factorial", bd=14, fg="yellow", bg="blue", width=14, font="Algerian", command=factorial)
b1.pack()
Label(root, text="~", font="20").pack()
Label(root, text="2-Seccond (Fibonacci)", fg="red", font="Algerian").pack()


# def fibonacci():
#     create2 = Toplevel()
#     create2.title("Factorial")
#     create2.geometry("800x800")
#     Label(create2, text="Factorial", fg="black", font="family, 20").pack()
#     text2 = Text(create2)
#     text2.pack()
#
#     def save2():
...
#
#     b1 = Button(create2, text="save", command=save2)
#     b1.pack()
#
#     def show2():
#         with open("output.txt") as f:
...
#
#     b2 = Button(create2, text="show", command=show2)
#     b2.pack()
b2 = Button(root, text="Fibonacci", bd=14, fg="yellow", bg="blue", width=14, font="Algerian", command=fibonacci)
b2.pack()
Label(root, text="").pack()
Label(root, text="~", font="20").pack()
Label(root, text="3-Third (Builtin Functions)", fg="red", font="Algerian").pack()
b3 = Button(root, text="Builtin Functions", bd=14, fg="yellow", bg="blue", width=14, font="Algerian", command=Builtin)
b3.pack()
Label(root, text="").pack()
Label(root, text="").pack()
Label(root, text="").pack()
Label(root, text="Made by: Keramatullah 'Hayat'", font="Algerian").pack()
Label(root, text="Faculty of: Computer Science", font="Algerian").pack()
Label(root, text="Department: Information Technology(IT)", font="Algerian").pack()
